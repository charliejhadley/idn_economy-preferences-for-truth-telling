# observeEvent(input$tab2_scatter_reset, {
#   shinyjs::reset("tab2_scatter_controls")
# })
# 
# output$tab2_scatter_selected_countries_UI <- renderUI({
#   
#   available_countries <- data_tab2_scatter %>%
#     select(country) %>%
#     .[[1]] %>%
#     unique()
#   
#   
#   selectInput(
#     "tab2_scatter_selected_countries",
...
# })
# 
# output$tab2_scatter_citation_selectize_UI <- renderUI({
#   
#   if (is.null(input$tab2_scatter_selected_countries)) {
#     available_citations <- data_tab2_scatter %>%
#       select(citation) %>%
#       .[[1]] %>%
#       unique()
#   } else {
#     available_citations <- data_tab2_scatter %>%
#       filter(country %in% input$tab2_scatter_selected_countries) %>%
#       select(citation) %>%
#       .[[1]] %>%
#       unique()
#   }
#   
#   selectInput(
#     "tab2_scatter_citation_selectize",
...
# })
# 
# data_tab2_scatter_hc <-
#   eventReactive(
#     c(
#       input$tab2_scatter_population_options,
#       input$tab2_scatter_citation_selectize,
#       input$tab2_scatter_repeated_or_oneshot,
#       input$tab2_scatter_location,
#       input$tab2_scatter_controls_suggested,
#       input$tab2_scatter_draw_or_mind,
#       input$tab2_scatter_selected_countries
#     ),
#     {
#       
#       if(is.null(input$tab2_scatter_selected_countries)){
...
#       )
#       
#       if (nrow(data_tab2_scatter) == 0) {
#         # no data
#         return(data_frame())
#       } else {
#         if (!is.null(input$tab2_scatter_citation_selectize)) {
#           data_tab2_scatter <- data_tab2_scatter %>%
#             filter(citation %in% input$tab2_scatter_citation_selectize)
#         }
#       }
#       
#       data_tab2_scatter
